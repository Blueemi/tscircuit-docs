...
Use `tolerance` to specify the acceptable variation in resistance as a percentage
string, e.g. `tolerance="5%"`, or a number between 0 and 1, e.g. `tolerance={0.05}`.
...
| `schSize` | The size of the schematic symbol. | `"normal"` |
